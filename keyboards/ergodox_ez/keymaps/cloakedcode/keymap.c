 ...
 * `----------+------+------+------+------+-------------'                 `-------------+------+------+------+------+--------'
 *   |Grv/L1  | Cmd  | Alt  | Left | Right|                                             |  Up  | Down |   [  |   ]  | ~L1  |
 *   `------------------------------------'                                             `----------------------------------'
 *                                        ,----------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(
  // left hand
  KC_GRV,          KC_1,          KC_2,          KC_3,    KC_4,    KC_5,    TG(BASE),
  KC_TAB,          KC_Q,          KC_W,          KC_E,    KC_R,    KC_T,    KC_LBRC,
  CTL_T(KC_ESC),   KC_A,          KC_S,          KC_D,    KC_F,    KC_G,
  KC_LSFT,         LT(SYMB,KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    TG(SYMB),
  KC_LCTL,         KC_LGUI,       KC_LALT,       KC_LEFT, KC_RGHT,
                                                           ALT_T(KC_APP), KC_LGUI,
                                                                          KC_HOME,
                                                         KC_SPC, KC_BSPC, GUI_T(KC_END),
  // right hand
  TG(BASE),      KC_6,    KC_7,    KC_8,    KC_9,              KC_0,           KC_MINS,
